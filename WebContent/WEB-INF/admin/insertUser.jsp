...
<c:set var="path_adau" value="${pageContext.request.contextPath }" />
<%
...
<link rel="stylesheet" href="${path_adau }/form_common.css">
<style>
</style>
</head>
<body>
			...
			<table class="table">
				<tbody>
					<tr>
						...
						<td>
							<div class="form-row">
								<input type="text" name="id" id="id" placeholder="아이디 입력" class="form-control" style="width:80%;display:inline-block;" autofocus required />
