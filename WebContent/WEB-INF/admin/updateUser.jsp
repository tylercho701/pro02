					...
					<table class="table">
						<tbody>
							<tr>
								...
								<td>
									<div class="form-row">
										<input type="text" name="id" id="id" placeholder="15글자 이내" class="form-control" maxlength="15" style="width:80%;display:inline-block;" value="${user.id }" readonly />
									</div>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									...
									<input type="text" name="postcode" id="postcode" style="width:160px;float:left;margin-right:20px;" placeholder="우편번호" class="form-control"><br>
							...
							<tr>
								<td colspan="2">
									...
									<a href="${path_aduu }/MemberList.do" class="btn btn-info">회원 목록</a>
								</td>
							</tr>
						</tbody>
					</table>
