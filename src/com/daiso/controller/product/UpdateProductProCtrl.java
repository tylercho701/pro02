...
public class UpdateProductProCtrl extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String savePath = "/product/images";	//업로드할 디렉토리
		...
		try {
			...
			pro.setPmeas(multi.getParameter("pstd"));
			pro.setPcom(multi.getParameter("pcom"));
			pro.setCategory(multi.getParameter("category"));
